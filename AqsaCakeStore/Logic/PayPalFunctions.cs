...
public class NVPAPICaller
{
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    encoder["BRANDNAME"] = "AQSA Cake Store";
    ...
    using (AqsaCakeStore.Logic.ShoppingCartActions myCartOrders = new AqsaCakeStore.Logic.ShoppingCartActions())
    {
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    {
      // Log the exception.
      AqsaCakeStore.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
    }
